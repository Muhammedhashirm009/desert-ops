...
@section('title', 'Receipt Voucher — DessertOps Accounts')
...
<div class="ph no-print">
  <div>
    <div class="ph-title">Receipt Voucher: {{ $voucher->voucher_number }}</div>
    <div class="ph-sub">Printable receipt record</div>
  </div>
</div>
...
<div class="card voucher-card" style="max-width:600px; margin:0 auto; border-top:4px solid var(--btn); position:relative; overflow:hidden;">
  <!-- Watermark -->
  <div style="position:absolute;top:50%;left:50%;transform:translate(-50%,-50%) rotate(-30deg);font-size:56px;font-weight:900;color:var(--green-lt);opacity:0.35;pointer-events:none;letter-spacing:6px;white-space:nowrap;z-index:0;">RECEIVED</div>
  <!-- Voucher Header -->
  <div style="padding:24px 24px 16px; text-align:center; border-bottom:2px solid var(--div2);">
    ...
    <div style="font-size:13px; font-weight:600; color:var(--green-tx); text-transform:uppercase; letter-spacing:2px; margin-top:4px;">Receipt Voucher</div>
  </div>
  ...
  <div style="padding:20px 24px;">
    <table style="width:100%; border-collapse:collapse;">
      <tbody>
        ...
        <tr>
          <td style="padding:8px 0; font-weight:600; color:var(--txt2); border-bottom:1px solid var(--div); font-size:13px;">Received From:</td>
          <td style="padding:8px 0; font-weight:600; color:var(--txt); border-bottom:1px solid var(--div); font-size:13px;">{{ $voucher->received_from ?? $voucher->payee }}</td>
        </tr>
