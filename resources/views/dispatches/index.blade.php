  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="mono">{{ $disp->dispatch_date->format('Y-m-d') }}</td>
        ...
        <td>
          <div style="display: flex; gap: 10px; justify-content: flex-end;">
            ...
            @if($disp->status === 'pending')
              <form action="{{ route('dispatches.destroy', $disp->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to cancel and delete this pending shipment?');" style="display: inline;">
                @csrf
                @method('DELETE')
