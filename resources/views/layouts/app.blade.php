...
<aside class="sb">
  ...
  <div class="sb-grp">
    ...
    <a href="{{ route('inventory.initialize') }}" class="nav-i {{ request()->routeIs('inventory.initialize') ? 'on' : '' }}">
      <span class="ni"><svg viewBox="0 0 24 24"><path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5"/></svg></span>Inventory Initialize
    </a>
  </div>
  @endif
