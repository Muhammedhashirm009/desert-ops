...
<aside class="sb">
  ...
  <div class="sb-grp">
    ...
    <a href="#" class="nav-i" style="pointer-events: none; opacity: 0.5;">
      <span class="ni"><svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="3"/><path d="M19.07 4.93a10 10 0 0 1 0 14.14M4.93 4.93a10 10 0 0 0 0 14.14"/></svg></span>Production (M2)
    </a>
    <a href="#" class="nav-i" style="pointer-events: none; opacity: 0.5;">
      <span class="ni"><svg viewBox="0 0 24 24"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg></span>Recipes & BOM (M2)
    </a>
  </div>
