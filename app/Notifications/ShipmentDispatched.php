...
class ShipmentDispatched extends Notification
{
    use Queueable;
    ...
    public function toArray(object $notifiable): array
    {
        ...
        return [
            ...
            'message' => "Shipment {$this->dispatch->dispatch_number} has been dispatched and is in transit ({$itemCount} items).",
            'url' => route('portal.dispatches'),
        ];
    }
}
